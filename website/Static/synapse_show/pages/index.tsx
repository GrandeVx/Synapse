  ...
  return (
      ...
      <div className="grid grid-row-6 scroll-smooth">
          ...
          <section className="grid grid-cols-2">
              ...
              {/* Area Destra */}
              <motion.section className="col-span-1 bg-gray-100 pl-13 pt-18 pb-18"             
                ...
                <motion.p className=" text-black text-7xl font-bold pt-4 " initial={{ opacity:0 }} animate={{ x:0, opacity:1 }} transition={{type: "spring",stiffness: 10,delay:0.1}}> Sense The </motion.p>
                <motion.p className=" text-transparent bg-clip-text bg-gradient-to-br from-purple-400 via-purple-600 to-pink-400 text-7xl font-bold pt-2" initial={{ opacity:0 }} animate={{ x:0, opacity:1 }} transition={{type: "spring",stiffness: 10,delay:0.15}}> Change.</motion.p>
              ...
              <motion.section className="col-span-1 bg-gradient-to-br from-purple-400 via-purple-600 to-pink-400"
                    initial={{ x:100, opacity:0 }}
                    animate={{ x:0, opacity:1 }}
                    transition={{
                      type: "spring",
          ...
          {/* HOW IT WORK */}
          <motion.section className="grid grid-row-2" id='tecnology' initial={{ opacity:0 }} animate={{ x:0, opacity:1 }} transition={{type: "spring",stiffness: 20}}>
            ...
            <section className="grid grid-cols-3 place-items-center text-center pb-20">      
                ...
                <motion.section className="col-span-1 " initial={{ opacity:0 }} animate={{ x:0, opacity:1 }} transition={{type: "spring",stiffness: 20}}>
                    <span className="">
                ...
                <motion.section className="col-span-1" initial={{ opacity:0 }} animate={{ x:0, opacity:1 }} transition={{type: "spring",stiffness: 20,delay:0.2}}>
                ...
                <motion.section className="col-span-1" initial={{ opacity:0 }} animate={{ x:0, opacity:1 }} transition={{type: "spring",stiffness: 20,delay:0.3}}>
          ...
          <section className="grid grid-cols-2 place-items-center">
              ...
              <motion.section className="" initial={{ x:-100,opacity:0 }} animate={{ x:0, opacity:1 }} transition={{type: "spring",stiffness: 20}}>
                <svg width="800" height="600" viewBox="-100 0 1440 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <motion.section className=" flex-row pt-0" initial={{ x:100,opacity:0 }} animate={{ x:0, opacity:1 }} transition={{type: "spring",stiffness: 20}}>
          ...
          <section className="grid grid-cols-2 place-items-center">
              ...
              <motion.section className="pl-20 flex-row " initial={{ x:-100,opacity:0 }} animate={{ x:0, opacity:1 }} transition={{type: "spring",stiffness: 20}}>
                <div className="">
                  <p className=" text-4xl font-semibold pt-0"> Download</p>
                  <p className="text-4xl font-semibold pt-1"> mobile App</p>
                  <p className=" text-gray-400 text-sm break-all pt-5"> Download Besnik mobile banking app</p>
                  <p className=" text-gray-400 text-sm break-all pt-1"> for IOS and android. It helps you banking</p>
                  <p className=" text-gray-400 text-sm break-all pt-1 pb-12"> quickily and more smartly</p>
              ...
              <motion.section className="grid  place-items-center" initial={{ x:100,opacity:0 }} animate={{ x:0, opacity:1 }} transition={{type: "spring",stiffness: 20}}>
              <svg width="800" height="600" viewBox="0 0 1440 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* FORM */} 
          <motion.section className="grid grid-row-2 place-items-center pb-20" initial={{ y:100,opacity:0}} animate={{ y:0, opacity:1 }} transition={{type: "spring",stiffness: 20}}>
          ...
          {/* FOOTER */}
          <motion.footer className="footer-1 bg-gray-100 py-8 sm:py-12" initial={{ y:200,opacity:0}} animate={{ y:0, opacity:1 }} transition={{type: "spring",stiffness: 20}}>
